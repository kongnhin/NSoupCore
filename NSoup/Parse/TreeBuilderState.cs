...
namespace NSoup.Parse
{
    ...
    internal abstract class TreeBuilderState
    {
        ...
        protected class InitialState : TreeBuilderState
        {
        ...
        protected class BeforeHtmlState : TreeBuilderState
        {
        ...
        protected class BeforeHeadState : TreeBuilderState
        {
            public override bool Process(Token t, TreeBuilder tb)
            {
                if (IsWhitespace(t))
        ...
        protected class InHeadState : TreeBuilderState
        {
            public override bool Process(Token t, TreeBuilder tb)
            {
                if (IsWhitespace(t))
        ...
        protected class InHeadNoscriptState : TreeBuilderState
        {
            public override bool Process(Token t, TreeBuilder tb)
            {
                if (t.IsDoctype())
        ...
        protected class AfterHeadState : TreeBuilderState
        {
            public override bool Process(Token t, TreeBuilder tb)
            {
                if (IsWhitespace(t))
        ...
        protected class InBodyState : TreeBuilderState
        {
            public override bool Process(Token t, TreeBuilder tb)
            {
                switch (t.Type)
            ...
            bool AnyOtherEndTag(Token t, TreeBuilder tb)
            {
        ...
        protected class TextState : TreeBuilderState
        {
        ...
        protected class InTableState : TreeBuilderState
        {
            public override bool Process(Token t, TreeBuilder tb)
            {
                if (t.IsCharacter())
        ...
        protected class InTableTextState : TreeBuilderState
        {
            public override bool Process(Token t, TreeBuilder tb)
            {
                switch (t.Type)
        ...
        protected class InCaptionState : TreeBuilderState
        {
            public override bool Process(Token t, TreeBuilder tb)
            {
        ...
        protected class InColumnGroupState : TreeBuilderState
        {
            public override bool Process(Token t, TreeBuilder tb)
            {
                if (IsWhitespace(t))
        ...
        protected class InTableBodyState : TreeBuilderState
        {
            public override bool Process(Token t, TreeBuilder tb)
            {
                switch (t.Type)
        ...
        protected class InRowState : TreeBuilderState
        {
            public override bool Process(Token t, TreeBuilder tb)
            {
                if (t.IsStartTag())
        ...
        protected class InCellState : TreeBuilderState
        {
            public override bool Process(Token t, TreeBuilder tb)
            {
                if (t.IsEndTag())
        ...
        protected class InSelectState : TreeBuilderState
        {
            public override bool Process(Token t, TreeBuilder tb)
            {
                switch (t.Type)
        ...
        protected class InSelectInTableState : TreeBuilderState
        {
            public override bool Process(Token t, TreeBuilder tb)
            {
        ...
        protected class AfterBodyState : TreeBuilderState
        {
            public override bool Process(Token t, TreeBuilder tb)
            {
                if (IsWhitespace(t))
        ...
        protected class InFramesetState : TreeBuilderState
        {
            public override bool Process(Token t, TreeBuilder tb)
            {
                if (IsWhitespace(t))
        ...
        protected class AfterFramesetState : TreeBuilderState
        {
            public override bool Process(Token t, TreeBuilder tb)
            {
                if (IsWhitespace(t))
        ...
        protected class AfterAfterBodyState : TreeBuilderState
        {
            public override bool Process(Token t, TreeBuilder tb)
            {
                if (t.IsComment())
        ...
        protected class AfterAfterFramesetState : TreeBuilderState
        {
            public override bool Process(Token t, TreeBuilder tb)
            {
                if (t.IsComment())
        ...
        protected class ForeignContentState : TreeBuilderState
        {
            public override bool Process(Token t, TreeBuilder tb)
            {
                return true;
        ...
        public static readonly TreeBuilderState Initial = new InitialState();
        public static readonly TreeBuilderState BeforeHtml = new BeforeHtmlState();
        public static readonly TreeBuilderState BeforeHead = new BeforeHeadState();
        public static readonly TreeBuilderState InHead = new InHeadState();
        public static readonly TreeBuilderState InHeadNoscript = new InHeadNoscriptState();
        public static readonly TreeBuilderState AfterHead = new AfterHeadState();
        public static readonly TreeBuilderState InBody = new InBodyState();
        public static readonly TreeBuilderState Text = new TextState();
        public static readonly TreeBuilderState InTable = new InTableState();
        public static readonly TreeBuilderState InTableText = new InTableTextState();
        public static readonly TreeBuilderState InCaption = new InCaptionState();
        public static readonly TreeBuilderState InColumnGroup = new InColumnGroupState();
        public static readonly TreeBuilderState InTableBody = new InTableBodyState();
        public static readonly TreeBuilderState InRow = new InRowState();
        public static readonly TreeBuilderState InCell = new InCellState();
        public static readonly TreeBuilderState InSelect = new InSelectState();
        public static readonly TreeBuilderState InSelectInTable = new InSelectInTableState();
        public static readonly TreeBuilderState AfterBody = new AfterBodyState();
        public static readonly TreeBuilderState InFrameset = new InFramesetState();
        public static readonly TreeBuilderState AfterFrameset = new AfterFramesetState();
        public static readonly TreeBuilderState AfterAfterBody = new AfterAfterBodyState();
        public static readonly TreeBuilderState AfterAfterFrameset = new AfterAfterFramesetState();
        public static readonly TreeBuilderState ForeignContent = new ForeignContentState();
        ...
        protected void HandleRcData(Token.StartTag startTag, TreeBuilder tb)
        {
            tb.Insert(startTag);
            tb.Tokeniser.Transition(TokeniserState.RcData);
            tb.MarkInsertionMode();
        ...
        protected void HandleRawText(Token.StartTag startTag, TreeBuilder tb)
        {
            tb.Insert(startTag);
